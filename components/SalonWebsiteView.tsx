          ...
          <section id="contact" className="bg-white dark:bg-slate-800 rounded-[2.5rem] p-8 md:p-12 border border-gray-200 dark:border-slate-700 shadow-sm scroll-mt-24">
             <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-slate-100 dark:bg-slate-900 rounded-3xl h-full min-h-[400px] border border-gray-200 dark:border-slate-700 overflow-hidden relative flex flex-col items-center justify-center text-center group">
                    ...
                    <div className="relative z-10 p-8 flex flex-col items-center justify-center w-full bg-slate-100/90 dark:bg-slate-900/90 backdrop-blur-sm m-4 rounded-2xl border border-white/50 dark:border-slate-700/50 shadow-xl max-w-[90%]">
                        <div className="w-16 h-16 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center text-red-500 mb-4 shadow-lg border border-gray-100 dark:border-slate-700 shadow-red-500/10">
                        ...
                        <p className="font-bold text-gray-900 dark:text-white mb-4 line-clamp-2 leading-relaxed">
                        ...
                        <div className="w-full h-px bg-gray-200 dark:bg-slate-700 mb-4 rounded-full"></div>
                        
                        <div className="flex flex-col gap-1 w-full text-center mb-6">
                           <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{language === 'tr' ? 'Çalışma Saatleri' : 'Working Hours'}</p>
                           ...
                           <p className="font-bold text-gray-400 text-sm">{language === 'tr' ? 'Pazar: Kapalı' : 'Sun: Closed'}</p>
                        </div>
                        
                        <div className="grid grid-cols-2 gap-3 w-full">
                           {directionsUrl && (
                               <a href={directionsUrl} target="_blank" rel="noopener noreferrer" className="bg-white dark:bg-slate-800 text-gray-900 dark:text-white py-2.5 rounded-xl font-bold shadow-sm hover:shadow-md transition-all border border-gray-200 dark:border-slate-600 flex items-center justify-center gap-1.5 text-sm">
                           ...
                           {businessProfile?.whatsapp_number && (
                               <a href={`https://wa.me/${businessProfile.whatsapp_number.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white dark:bg-[#25D366]/20 dark:hover:bg-[#25D366] py-2.5 rounded-xl font-bold shadow-sm hover:shadow-md transition-all border border-transparent flex items-center justify-center gap-1.5 text-sm">
                           ...
                           {businessProfile?.instagram_url && (
                               <a href={businessProfile.instagram_url} target="_blank" rel="noopener noreferrer" className="bg-pink-50 text-pink-600 hover:bg-pink-600 hover:text-white dark:bg-pink-900/20 dark:text-pink-400 dark:hover:bg-pink-600 dark:hover:text-white py-2.5 rounded-xl font-bold shadow-sm hover:shadow-md transition-all border border-transparent flex items-center justify-center gap-1.5 text-sm">
                                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
                                  Instagram
                               </a>
                           )}
                           
                           <button onClick={onStartBooking} className="col-span-2 w-full bg-accent text-white py-3 rounded-xl font-bold shadow-md hover:bg-blue-600 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 mt-1">
