...
export const seedDemoData = () => {
  ...
  localStorage.removeItem(`users`); // Will regenerate default admin
  localStorage.removeItem(`business_profile_${tenantId}`);
  localStorage.removeItem(`services_${tenantId}`);
  localStorage.removeItem(`staff_${tenantId}`);
  localStorage.removeItem(`appointments_${tenantId}`);
  localStorage.removeItem(`mock_tenant_customers_${tenantId}`);
  ...
  localStorage.setItem(`business_profile_${tenantId}`, JSON.stringify(businessProfile));
  ...
  localStorage.setItem(`staff_${tenantId}`, JSON.stringify(staffList));
