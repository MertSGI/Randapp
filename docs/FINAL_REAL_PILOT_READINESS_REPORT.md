...
1. **Data Loss Risk**: Operating a real pilot on localStorage (`VITE_DATA_MODE=mock`) will cause complete data loss when the user changes devices or clears cache.
